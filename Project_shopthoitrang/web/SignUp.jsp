            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-6 text-center mb-5">
                        <h2 class="heading-section">SHOP-NVTV</h2>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-12 col-lg-10">
                        <div class="wrap d-md-flex">
                            ...
                            <div class="login-wrap p-4 p-md-5">
                                ...
                                <form action="SignUpControl" class="signin-form">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="password" name="txtreppass" class="form-control" placeholder="Repeat Password" required>
                                    </div>
